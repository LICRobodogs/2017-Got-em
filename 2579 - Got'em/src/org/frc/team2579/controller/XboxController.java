...
public class XboxController {
	...
	/**
	 * Returns -1 if nothing is pressed, or the angle of the button pressed 0 =
	 * up, 90 = right, etc.
	 */
	 ...
	 * 
	 * public boolean getDPadRight(){ return
	 * (stick.getRawAxis(LEFT_RIGHT_DPAD_AXIS) > RIGHT_DPAD_TOLERANCE); }
	 * 
	 * public boolean getDPadTop(){ return
	 * (stick.getRawAxis(TOP_BOTTOM_DPAD_AXIS) < TOP_DPAD_TOLERANCE); }
	 * 
