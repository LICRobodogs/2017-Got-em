...
public class BHRMathUtils {
	...
	public static double adjustAccumAngleToDesired(double currentAccumAngle,
			double desiredAngle0To360) {
	...
	public static double adjustAccumAngleToClosest180(double currentAccumAngle) {
		double normalizedAngle = Math
				.abs(normalizeAngle0To360(currentAccumAngle));
	...
	public static void main(String[] args) {
		System.out.println("Accum angle to desired 721 to 45 = "
				+ adjustAccumAngleToDesired(721, 45));
	}
}
