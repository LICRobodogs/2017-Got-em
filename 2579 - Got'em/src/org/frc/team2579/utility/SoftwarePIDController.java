...
public class SoftwarePIDController {
	...
	public SoftwarePIDController(PIDParams pidParams,
	...
	public void setPIDTurnTarget(double targetAngleDeg, double maxError,
			double maxPrevError, MPSoftwareTurnType turnType) {
	...
	public boolean controlLoopUpdate(double currentGyroAngle) {
		...
		if (Math.abs(error) < maxError
				&& Math.abs(deltaLastError) < maxPrevError) {
			return true;
		}
